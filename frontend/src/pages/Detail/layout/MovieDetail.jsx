         ...
         <div className="flex flex-col mt-10">
                  <div className="text-3xl mb-5">MOVIE MARKY</div>
                    <div className="flex items-end mt-3">
                        <label className="w-1/12 text-sm text-end pb-2">영화 제목 </label>
